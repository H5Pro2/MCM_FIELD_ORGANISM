...
from mcm_field_organism.public_av_return_resolution_curve import (  # noqa: E402
    execute_public_av_return_resolution_curve,
...
OUTPUT = Path("reports/public_av_return_resolution_curve_v1.json")


def main() -> int:
    curve = execute_public_av_return_resolution_curve(MEDIA, nasa_earthrise_av_source_contract())
