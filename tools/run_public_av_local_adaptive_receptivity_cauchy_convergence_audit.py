...
from mcm_field_organism.public_av_local_adaptive_receptivity_cauchy_convergence_audit import (  # noqa: E402
    execute_public_av_local_adaptive_receptivity_cauchy_convergence_audit,
)
...
OUTPUT = Path("reports/public_av_local_adaptive_receptivity_cauchy_convergence_audit_v1.json")


def main() -> int:
    payload = execute_public_av_local_adaptive_receptivity_cauchy_convergence_audit(
