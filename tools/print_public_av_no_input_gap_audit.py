...
def main() -> int:
    ...
    print(json.dumps(public_av_no_input_gap_audit_json_value(audit), indent=2, sort_keys=True))
    return 0 if audit.audit_complete and not audit.field_run_allowed else 1
