...
from mcm_field_organism.public_av_local_adaptive_receptivity_coupling_scheme_audit import (  # noqa: E402
    execute_public_av_local_adaptive_receptivity_coupling_scheme_audit,
)
...
OUTPUT = Path("reports/public_av_local_adaptive_receptivity_coupling_scheme_audit_v1.json")


def main() -> int:
    payload = execute_public_av_local_adaptive_receptivity_coupling_scheme_audit(
