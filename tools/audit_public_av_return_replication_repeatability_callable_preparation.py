...
from audit_public_av_return_replication_repeatability_gate_instantiation import (  # noqa: E402
    MEDIA_PATH,
)
...
def main() -> int:
    ...
    preflight = audit_public_av_return_replication_repeatability_preflight(
        ...
        repeatability_wiring=repeatability,
        base_wiring=base,
    ...
    gates = reserve_public_av_return_replication_repeatability_gate_instances(acceptance)
    contract = prepare_public_av_return_replication_repeatability_executor_callables(gates)
    print(json.dumps(
        public_av_return_replication_repeatability_callable_preparation_to_jsonable(contract),
        indent=2,
        sort_keys=True,
    ))
    return 0 if contract.callable_preparation_contract_complete else 1
