...
def main() -> int:
    ...
    print(json.dumps(public_av_return_replication_runner_json_value(wiring), indent=2, sort_keys=True))
    return 0 if wiring.wiring_complete and not wiring.replication_run_allowed else 2
