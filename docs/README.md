...
[S1-ZD](S1ZD_LPRH1F_STATISCHER_PRIVATER_PROPOSAL_ANWENDUNGS_MATERIALISIERBARKEITSAUDIT.md).

S1-ZC bindet statisch eine private atomare Ein-Schritt-Anwendung und die
zwingende Folgelayergleichheit von Kandidat und wertgleicher generischer
Baseline. Noch keine Implementierung. Siehe
[S1-ZC](S1ZC_LPRH1F_STATISCHER_PRIVATER_PROPOSAL_ANWENDUNGS_UND_BASELINEVERTRAG.md).
...
[S1-ZA](S1ZA_LPRH1F_PRIVATE_LAYERGEBUNDENE_CONSUMER_IMPLEMENTIERUNG.md).
...
[S1-YV](S1YV_LPRH1F_STATISCHER_FINALER_PREFLIGHT_KORREKTURVERTRAG.md).
...
[S1-YT](S1YT_LPRH1F_STATISCHER_PREFLIGHT_BINDUNGSKORREKTURVERTRAG.md).

S1-YS blockiert privaten LPRH-1F-Consumer-Code wegen sechs verbleibender
Signatur-, Typ-, Payload-, Mapping- und Fehlerbindungen. Die generisch
reduzierbare Engineeringeinordnung bleibt erhalten. Siehe
[S1-YS](S1YS_LPRH1F_STATISCHER_ABSCHLUSS_UND_IMPLEMENTIERUNGSPREFLIGHT.md).
...
S1-YI schliesst alle sieben LPRH-1-Materialisierungsblocker mit exakten
Payload-, Typ-, Ordnungs-, Einmaligkeits-, Envelope- und Budgetregeln. Noch
