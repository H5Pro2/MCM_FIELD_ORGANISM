# Erneute Huerde A: Umfangsbindung der privaten Einmalverkettung

## 1. Status

Dieses Dokument beginnt nach der neuen privaten Verkettungsdatei die erforderliche erneute Huerde-A-Pruefung. Es bindet den vollstaendigen statischen Umfang, fuehrt aber keine Module, Tests, Bindungen, Handoffs oder Runtime-Pfade aus.

## 2. Vollstaendige Bytebindung
...
Die Menge umfasst exakt 18 Vertragsdokumente, 25 Produktionsmodule, eine gesonderte Exportgrenze und vier private Tests. Dateien ausserhalb dieser Menge duerfen an einem spaeteren Einmallauf nicht beteiligt sein.

## 3. Neue private Verkettungsgrenze

Die neue Datei ist nur eine nicht exportierte Definition. Statisch bestaetigt sind genau eine Funktion, drei private Importe, ein Bindungsaufruf, ein Handoff-Aufruf, kein direkter Ablaufkoordinatoraufruf, keine Verzweigung und keine weitere Produktionsaufrufstelle.

Jede Aenderung einer gebundenen Datei, jeder weitere Import oder Aufruf und jeder Export sperrt die Huerden A bis F erneut. Die Huerden B bis F muessen auf dieser neuen Bytebasis erneut statisch bewertet werden.
...
## 5. Entscheidung und Aussagegrenze

Huerde A ist nur zur unabhaengigen statischen Review vorbereitet. Huerde F, Huerde G und jede reale Ausfuehrung bleiben gesperrt.

Kein Befund zu Feldwirkung, Kontaktgeschichte, Memory, Organisation, Bedeutung, Semantik, Bewusstsein, Eigenstaendigkeit oder KI. Keine Zielabweichung ist erkennbar; die Aenderung verbindet nur zwei bereits private technische Grenzen und programmiert keinen Inhalt oder Zielzustand vor.
