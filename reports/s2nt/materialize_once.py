"""Authorized NT materialization and one offline verification; no evaluation."""
import json
from tools import _s2nt_private_receptor_materialization as m
from tools import _s2nt_private_materialization_verification as v


def main():
    m.require(not (m.ROOT/"reports/s2nt"/m.RUN_ID).exists(),"RUN_DIRECTORY_ALREADY_EXISTS")
    ...
    return 0 if proof["status"] == "S2NT_MATERIALIZATION_VALID" else 1
