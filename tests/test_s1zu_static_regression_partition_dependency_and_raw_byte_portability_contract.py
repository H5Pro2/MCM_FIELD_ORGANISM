...
class S1ZUStaticPartitionAndPortabilityContractTests(unittest.TestCase):
    ...
    def test_partition_counts_are_disjoint_and_complete(self) -> None:
        ...
        self.assertEqual(914, len(list((_ROOT / "tests").glob("test_*.py"))))
    ...
    def test_exact_future_rules_extend_but_do_not_replace_w1f_rules(self) -> None:
        contract = _contract()
        ...
        self.assertEqual(current, future[:3])
