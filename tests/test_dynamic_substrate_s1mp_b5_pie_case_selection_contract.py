...
from mcm_field_organism.dynamic_substrate_s1mp_b5_pie_case_selection_contract import (
    DTS1S1MPB5PIECaseSelectionContractError,
    S1_MP_DECISION,
    build_dts1_s1mp_b5_pie_case_selection_contract,
)


class DTS1S1MPB5PIECaseSelectionContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.contract = build_dts1_s1mp_b5_pie_case_selection_contract()

    def test_binds_exact_s1mo_source_and_registered_c17(self) -> None:
        self.assertEqual(64, len(self.contract.source_s1mo_digest))
        self.assertEqual(
            (
                "C17",
                "B5",
    ...
    def test_binds_embedded_m_state_and_b5_configuration(self) -> None:
        ...
        self.assertIn("uniform-M-and-the-bound-full-B5-arm", joined)
        self.assertIn("carry-only-between-the-two-ordered-intervals", joined)

    def test_binds_dual_digest_roles_and_b5_residual_rule(self) -> None:
        self.assertEqual(
            "output_digest",
